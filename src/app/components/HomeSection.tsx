            ...
            <div className="max-w-3xl space-y-8">
              ...
              <div className="flex flex-row gap-6 pt-4">
                ...
                <Link href="/eventos" className="block group relative">
                  ...
                  <Button
                    variant="outline"
                    className="relative text-white border-white/30 hover:border-white hover:bg-white/10 text-lg px-4 md:px-6 py-6 transition-all duration-300 flex items-center gap-2"
                  >
